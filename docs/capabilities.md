...
| Shared component metadata | Stable | Registry connects parsers, validation, field mutation, schema export and Inspector metadata. Parsers and Lua service signatures are still handwritten; this is not full single-source generation. |
