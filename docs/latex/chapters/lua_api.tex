...
The compatibility hover/click event contains \code{id}, \code{label},
\code{mouse\_x}, and \code{mouse\_y}. Typed events cover value changes,
focus, submit/cancel, pointer enter/exit, press/release, drag/drop, and scroll.
...
Entity & Entity lookup, creation, destruction, and sprite appearance. \\
