...
\begin{itemize}
  ...
  \item drawing imported alpha-capable textures when available;
...
Window mode changes are requested from Lua and applied by the runtime loop. Lua can also pause or resume physics through \code{Physics.set\_enabled} and request shutdown through \code{Application.quit}.
