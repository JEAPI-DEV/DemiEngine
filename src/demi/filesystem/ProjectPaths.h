...
[[nodiscard]] bool hasExtension(const std::filesystem::path& path, const char* extension);
...
[[nodiscard]] std::vector<std::filesystem::path> collectKnownSourceFiles(const std::filesystem::path& root);
