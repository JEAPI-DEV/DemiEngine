...
texture importer settings, collision-aware movement, debug colliders, and the
`Physics3D` spatial-query API. Its project file sets explicit budgets of 16.67
ms per frame, 128 draw calls, and 64 resident assets.
